...
```{r}
#Import project folder to RStudio - if you're seeing this file, you're data are not on the RStudio VM yet.
system("mkdir -p /Users/tyson_swetnam/Downloads/bighorns")
setwd("/Users/tyson_swetnam/Downloads/bighorns")
system("iget -KPbfrT --retries 3 -X checkpoint-file /iplant/home/tyson_swetnam/bighorns/CPNWR_DBS_Locs_02Nov17.csv /Users/tyson_swetnam/Downloads/bighorns")
system("iget -KPbfrT --retries 3 -X checkpoint-file /iplant/home/tyson_swetnam/bighorns/gps_global_beam_flat_temp.csv /Users/tyson_swetnam/Downloads/bighorns")
``` 
